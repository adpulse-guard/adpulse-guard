(function () {
  const CONFIG = {
    clientId: 'client_003',
    siteToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbGllbnRJZCI6ImNsaWVudF8wMDMiLCJpYXQiOjE3NzA4MjM3MzIsImV4cCI6MTc3MjAzMzMzMn0.ZnSgJBshjAsGqYbJelaOa760GboEmEY6tkYpWZLNhxE',
    allowedDomain: 'libn.com',
  ...
  if (!host.includes(CONFIG.allowedDomain)) return;
